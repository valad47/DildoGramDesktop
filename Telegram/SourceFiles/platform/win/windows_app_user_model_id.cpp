...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"vlmGram.vlmGramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"vlmGram.vlmGramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"vlmGram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"vlmGram Desktop/vlmGram.lnk"_q;
	const auto old = u"vlmGram for Windows/vlmGram.lnk"_q;
