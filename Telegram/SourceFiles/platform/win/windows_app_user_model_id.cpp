...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"DildoGram.DildoGramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"DildoGram.DildoGramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"DildoGram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"DildoGram Desktop/DildoGram.lnk"_q;
	const auto old = u"DildoGram for Windows/DildoGram.lnk"_q;
