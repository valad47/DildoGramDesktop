...
void CheckReactionNotificationSchedule(
	...
	if (((peer->isChannel() && !peer->isMegagroup() && !settings.showChannelReactions)
		...
		&& from == Api::ReactionsNotifyFrom::None) {
...
[[nodiscard]] TextWithEntities UnsupportedMessageText() {
	const auto siteLink = u"https://t.me/DildoGramReleases"_q;
	auto result = TextWithEntities{
		tr::lng_message_unsupported(tr::now, lt_link, siteLink).replace("Telegram", "DildoGram")
	};
